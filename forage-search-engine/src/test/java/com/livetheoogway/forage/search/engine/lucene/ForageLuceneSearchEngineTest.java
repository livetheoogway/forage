...
class ForageLuceneSearchEngineTest {
    ...
    @Test
    void testThatThereAreNoErrorsWhenThereIsNothingToIndex() throws Exception {
        InMemoryHashStore<Book> dataStore = new InMemoryHashStore<>();
        try (ForageLuceneSearchEngine<Book> searchEngine = ForageSearchEngineBuilder.<Book>builder()
